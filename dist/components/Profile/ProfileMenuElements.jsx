...
const ProfileMenuElements = () => {
    return (<div className="grid grid-cols-1 gap-[15px] divide-y shadow-standart rounded-[10px] mt-[20px] lg:mt-[40px] p-[20px] bg-white">
            <ProfileMenuElement />
            <ProfileMenuElement />
            <ProfileMenuElement />
            <ProfileMenuElement />
...
exports.default = (0, react_1.memo)(ProfileMenuElements);
const ProfileMenuElement = (0, react_1.memo)(({ element }) => {
    return (<div className="pt-[15px] first:pt-0">
